  ...
  Widget build(BuildContext context) {
    ...
    final sendButton = SizedBox(
      child: ElevatedButton(
       ...
       onPressed: () async {
       try {
        await fireclass.addTodoFire(TodoFire(todoId: const Uuid().v4(), title: firecontroller.text, createdAt: DateTime.now()));
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Todo Fire"), backgroundColor: Colors.blue,),
      body: Column(
          ...
          child: ListTile(
            title: isEditing
                ...
                : Column(
                    ...
                    children: [
                      Text(todo.title),
                      Text(DateFormat('yyyy年MM月dd日 HH:mm').format(todo.createdAt))
                    ],
                  ),
              trailing: IconButton(
